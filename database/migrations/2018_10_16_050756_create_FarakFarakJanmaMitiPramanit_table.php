...
class CreateFarakFarakJanmaMitiPramanitTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('FarakFarakJanmaMitiPramanit', function (Blueprint $table) {
            $table->increments('id');
...
$table->text('valid_dob')->nullable();
$table->text('mistake_document')->nullable();
$table->text('mistake_dob')->nullable();
...
$table->text('officer')->nullable();
    ...
    {
        Schema::dropIfExists('FarakFarakJanmaMitiPramanit');
    }
}
