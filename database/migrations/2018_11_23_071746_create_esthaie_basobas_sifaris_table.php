...
class CreateEsthaieBasobasSifarisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('esthaie_basobas_sifaris', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('esthaie_basobas_sifaris');
    }
}
