...
class CreateDharaJadanSifarisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
         Schema::create('dhara_jadan_sifaris', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->text('khanepani_line_name')->nullable();
    ...
    {
        Schema::dropIfExists('dhara_jadan_sifaris');
    }
}
