...
class CreateSasthaDartaSifarisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SasthaDartaSifarisa', function (Blueprint $table) {
            $table->increments('id');
...
$table->text('sabik_type')->nullable();
 $table->text('officer')->nullable();
    ...
    {
        Schema::dropIfExists('SasthaDartaSifarisa');
    }
}
