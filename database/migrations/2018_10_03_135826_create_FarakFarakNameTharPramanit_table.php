...
class CreateFarakFarakNameTharPramanitTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('FarakFarakNameTharPramanit', function (Blueprint $table) {
            $table->increments('id');
...
$table->text('officer')->nullable();
    ...
    {
        Schema::dropIfExists('FarakFarakNameTharPramanit');
    }
}
