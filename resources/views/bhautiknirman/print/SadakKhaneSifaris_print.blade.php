...
<page size="A4" >
  <div class="x_content">
   ...
   <!--  <div class="col-md-12">
      ...
      <div class="col-md-8">
       ...
       <p align="center" class="font-size-24"><b> <?php

       echo empty($local_state_name)?"":$local_state_name; ?> </b></p>
       <p align="center" class="font-size-24">
        <b> <?php echo empty($ward_no)?" ":$ward_no;?> नं वडा कार्यालय, <?php echo empty($ward_office)?"":$ward_office;?> </b></p>
        <p align="center" class="font-size-24"><b><?php echo empty($province_id)?"":$province_id;?> नं. प्रदेश, नेपाल</b></p>
  ...
  <div class="top-part">
    ...
    <!-- <div class="col-md-12">
      <div class="col-md-6">
       <p align="left"><b><span <?php echo empty($print_mode)?"":$print_mode;?>>पत्र संख्या:</span>&nbsp; {{$data->patra_sankya}}</b></p>
       <p align="left"><b><span <?php echo empty($print_mode)?"":$print_mode;?>>चलानी नं.:</span>&nbsp; {{$data->chalani_no}}</p>
     </div>
     <div class="col-md-6">
      <p align="right"><b><span <?php echo empty($print_mode)?"":$print_mode;?>>मिति:</span>&nbsp; {{$data->issued_date}}</b></p>
    </div>
...
<div class="col-md-12">
 <center>
     ...
     <a class="btn btn-fixed" href="{{url('home')}}"><span class="glyphicon glyphicon-home"></span>गृहपृष्ठ </a>
       <a class="btn btn-fixed"  href="sadakkhanesifaris/{{$data->id}}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
    <a class="btn btn-fixed" id="print_sadak_khane_swikriti"><span class="glyphicon glyphicon-print"></span> प्रिन्ट गर्नुहोस </a>


    <a class="btn btn-fixed" href="{{url('sadakkhanesifaris/create')}}"><span class="glyphicon glyphicon-print"></span> नयाँ फर्म खोल्नुहोस</a>
  </div>
</center>
  </div>
...
<script type="text/javascript">
  ...
  $('#print_sadak_khane_swikriti').click(function() {
    $('.hide-button').hide();
