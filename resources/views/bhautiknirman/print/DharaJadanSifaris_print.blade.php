 ...
 <!--  <footer>
  ...
  <div class="col-md-12">
    <center>
      ...
      <a class="btn btn-fixed" href="dharajadansifaris/{{$data->id}}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
      <a class="btn btn-fixed" id="print_dhara_jadan_sifaris"><span class="glyphicon glyphicon-print"></span> प्रिन्ट गर्नुहोस </a>


   <a class="btn btn-fixed" href="{{url('dharajadansifaris/create')}}"><span class="glyphicon glyphicon-print"></span> नयाँ फर्म खोल्नुहोस</a>
 </div>
</center>
    </div>
...
<script src="{{ asset('admin/bower_components/jquery/dist/jquery.min.js') }}"></script>
 ...
 <script type="text/javascript">
  ...
  $('#print_dhara_jadan_sifaris').click(function() {
    $('.hide-button').hide();
