  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('sadakkhanesifaris', [$data->id])}}" method="post">
          {{method_field('PATCH')}}
          {{ csrf_field() }}
          <div class="x_content">
           ...
           <!--  <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="col-md-6">
               <p align="left"><b>पत्र संख्या&nbsp;<input type="text" class="dashed-input-field" value="{{$data->patra_sankya}}" placeholder="   *" name="patra_sankya" id="patra_sankya" required="required"/></b></p>
          ...
          <div class="col-md-12">
            ...
            <p> 
              ...
              <input type="text" class="dashed-input-field" placeholder="   *" required="required" value="{{$data->person_name}}" name="person_name"/>
            </p>
            <p>
             {{$local_state[0]->local_state_name}}</b> वडा न. <b>{{Helpers::convertNos(auth()->user()->isAdmin)}}</b>
           </p>
           <p>
           ...
           <p align="left">
            तपाईको त्यस कार्यालयको मिति<input type="text" class="dashed-input-field ndp-nepali-calendar" placeholder="   *" required="required" name="application_submit_date" id="application_submit_date" value="{{$data->application_submit_date}}" onfocus="showNdpCalendarBox('application_submit_date')"/> को निवेदन पत्र अनुसार निम्न बमोजिम स्थानको <input type="text" class="dashed-input-field" placeholder="   *" required="required" value="{{$data->sadak_location}}" name="sadak_location"/> सडक खन्ने अनुमति दिईएको छ | लेखिए बमोजिमको शर्तहरु पालना गरी  यो पत्र प्राप्त भएको मितिले <input type="text" class="dashed-input-field" placeholder="   *" required="required" value="{{$data->work_complete_days}}" name="work_complete_days"/> दिन भित्र कार्य सम्पन्न गर्नुहोला | </p>
            <p><b>खन्न स्वीकृति प्रदान गरको सडक <input type="text" class="dashed-input-field" value="{{$data->swikrit_sadak_name}}" placeholder="   *" required="required" name="swikrit_sadak_name"/></b></p>

            <p><b>सडक खन्न स्वीकृति प्रदान गरको इकाइ <input type="text" class="dashed-input-field" value="{{$data->swikrit_pradan_unit}}" placeholder="   *" required="required" name="swikrit_pradan_unit"/></b>बर्ग मिटर</p>
            <p><b>सडक खन्न स्वीकृति प्रदान धरौटी रकम रु.<input type="text" class="dashed-input-field" value="{{$data->deposite_amount}}" placeholder="   *" required="required" name="deposite_amount"/></b></p>
            <p><b>शर्तहरु</b></p>
          ...
          <div class="col-md-12">
            <div class="col-md-6">
              ...
              <p><b> <input type="text" class="dashed-input-field" placeholder="   *" required="required" value="{{$data->applicant_address}}" name="applicant_address"/></b></p>
              </div>
              <div class="col-md-6">
          ...
          <div class="col-md-12">
            ...
            <center><input  type="submit" class="btn btn-success" name="update_sadak_khane_sifaris_data" value="रेकर्ड सेभ गरी प्रिन्टको लागि तयार गर्नुहोस"></center>
          </div>
        </div>
      </div>
