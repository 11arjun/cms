...
<a class="btn btn-success" href="dharajadansifaris/{{$data->id}}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
...
<div class="col-md-12 title-left">
 ...
 <p>&nbsp; &nbsp;<b>{{$data->office_name}} </b>| </p>
       ...
       <div class="col-md-12 content-para">
        ...
        <p align="justify"><b> {{$local_state[0]->local_state_name}}</b> वडा नं.  <b> {{Helpers::convertNos(auth()->user()->isAdmin)}} </b> (साबिकको ठेगाना <b>{{$data->sabik_address}}</b>) बस्ने
            <b>
         {{$data->person_title}} {{$data->person_name}} </b> नाममा दर्ता कायम रहेको कि.नं. <b>{{$data->kitta_no}}</b> को जग्गामा मिति <b>{{$data->house_approve_date}}</b> मा भवन निर्माण स्वीकृति लिनु भई

          <b>{{$data->construction_type}}</b> रुपमा निर्माण सम्पन्न गर्नुभएको वा अभिलेखीकरण गर्नुभएको हुदाँ <b>{{$data->khanepani_line_name}}</b>
        खानेपानी लाइन जडान गरिदिन हुन सिफारिस साथ अनुरोध गरिन्छ| </p>
      </div>
      <div class="col-md-12">
 ...
 <!--  <footer>
  ...
  <div class="col-md-12">
    <center>
      ...
      <!-- <a class="btn btn-success btn-fixed" href="dharajadansifaris/{{$data->id}}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
      <a class="btn btn-success btn-fixed" id="print_dhara_jadan_sifaris"><span class="glyphicon glyphicon-print"></span> प्रिन्ट गर्नुहोस </a> -->


   <a class="btn btn-success btn-fixed" href="{{url('dharajadansifaris/create')}}"><span class="glyphicon glyphicon-print"></span> नयाँ फर्म खोल्नुहोस</a>
 </div>
</center>
    </div>
@endforeach
