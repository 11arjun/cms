...
<div class="right_col" role="main">
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('bijulijadansifaris')}}" method="post">
            {{ csrf_field() }}
 ...
 -->
         ...
         <div class="col-md-12">
          ...
          <p><b>{{$local_state[0]->local_state_name}}</b> वडा नं. <b>{{Helpers::convertNos(auth()->user()->isAdmin)}} </b> (साबिकको ठेगाना <input type="text" class="dashed-input-field star" name="sabik_address" id="sabik_address" autocomplete="off" required="required">
) बस्ने 
          ...
          रुपमा निर्माण सम्पन्न गर्नुभएको वा अभिलेखीकरण गर्नुभएको हुदाँ निजलाई <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="electricity_capacity">एम्पियर क्षमताको  <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="electricity_line_name"> बिजुलीको लाइन जडान गरिदिनुहुन सिफारिस साथ अनुरोध गरिन्छ| </p> 
        </div>
        <div class="col-md-12">
            ...
            <table class="table table-bordered" id="bijuli_jadan_kitta_table">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="   bijuli_jadan_kitta_no[]"> 
                    <td><button href="" id="add_more_bijuli_kitta_no" class="btn btn-success" ><span class="glyphicon glyphicon-plus"></span></button></td>
                  </tr>
                </tbody>
              </table>
      ...
      <input type="text" name="nibedak_nid" class="form-control" required>
          ...
          <div class="col-md-12">
            ...
            <center><input  type="submit" class="btn btn-success" name="save_bijuli_jadan_sifaris_data" value="रेकर्ड सेभ गरी प्रिन्टको लागि तयार गर्नुहोस"></center>
          </div>
        </div>
      </div>
