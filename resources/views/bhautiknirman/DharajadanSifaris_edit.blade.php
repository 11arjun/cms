  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('dharajadansifaris',[$data->id])}}" method="post">
           {{method_field('PATCH')}}
          {{ csrf_field() }}
          <div class="x_content">
          ...
          <div class="col-md-12">
           <p>श्री<input type="text" class="dashed-input-field" placeholder="   *" value="{{$data->office_chairman}}" required="required" name="office_chairman"></p>
         ...
         <div class="col-md-12">
          ...
          <p><b> {{$local_state[0]->local_state_name}}</b> वडा नं.  <b>{{Helpers::convertNos(auth()->user()->isAdmin)}}</b> (साबिकको ठेगाना <input type="text" class="dashed-input-field star" name="sabik_address" id="sabik_address" value="{{$data->sabik_address}}" autocomplete="off" required="required">) बस्ने 
          ...
          </select> <input type="text" class="dashed-input-field" placeholder="   *" required="required" value="{{$data->person_name}}" name="person_name">को नाममा दर्ता कायम रहेको कि.नं.<input type="text" class="dashed-input-field" placeholder="   *" required="required" value="{{$data->kitta_no}}" name="kitta_no">को जग्गामा मिति <input type="text" class="dashed-input-field" placeholder="   *" required="required" id="house_approve_date" value="{{$data->house_approve_date}}"  name="house_approve_date"> मा भवन निर्माण स्विकृत लिनु भई  
          ...
          रुपमा निर्माण सम्पन्न गर्नुभएको वा अभिलेखीकरण गर्नुभएको हुदा  <input type="text" class="dashed-input-field" placeholder="   *" required="required" value="{{$data->khanepani_line_name}}" name="khanepani_line_name"> खानेपानी लाइन जडान गरिदिन हुन सिफारिस साथ अनुरोध गरिन्छ| </p> 
        </div>
        <div class="col-md-12">
        </div>
                ...
                @foreach($detail as $d)
                    <tr>
                      <td><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="" value="{{ Helpers::convertNos($count)}}"> </td>
                         <?php $count++; ?>
                      <td><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="dhara_jadan_kitta_no[]" value="{{$d->dhara_jadan_kitta_no}}"></td>
                     
                      <td><a id="add_more_kitta_no" class="btn btn-success" ><span class="glyphicon glyphicon-plus"></span></a></td>
        ...
        <input type="text" name="nibedak_nid" class="form-control" value="{{$data->nibedak_nid}}" required>
          ...
          <div class="col-md-12">
            ...
            <center><input  type="submit" class="btn btn-success" name="update_dhara_jadan_sifaris_data" value="रेकर्ड सेभ गरी प्रिन्टको लागि तयार गर्नुहोस"></center>
          </div>
        </div>
      </div>
    </form>
