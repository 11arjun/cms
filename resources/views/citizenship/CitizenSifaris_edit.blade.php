...
<form action="{{url('CitizenSifaris', [$data->id])}}" method="POST" >
           {{method_field('PATCH')}}
          {{ csrf_field() }}
    ...
    <div class="col-md-6">
      {{-- <p align="left"><b>पत्र संख्या :<input type="text" class="dashed-input-field" placeholder="   *" name="patra_sankya" value="२०७५/०७६" id="patra_sankya" required="required" value="{{$data->patra_sankya}}"> </b></p>
  ...
  <input type="hidden" name="letter_subject" value="नेपाली नागरिकताको प्रमाण-पत्र प्रतिलिपि पाऊँ">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <p>
                  यस नगरपालिका अन्तर्गत निम्न लिखित विवरण भएका श्री <input type="text" class="dashed-input-field" placeholder="   *" name="n_name" required="required" value="{{$data->n_name}}"> ले स्थायी नेपाली नागरिकताको प्रमाण-पत्र बनाउनको लागि सिफारिस पाऊ भनि निबेदन दिएको हुँदा निम्न विवरणमा उल्लेखित ब्यक्तिलाई स्थायी नेपाली नागरिकताको प्रमाण-पत्र उपलब्ध गराई दिनुहुन सिफारिस साथ अनुरोध गर्दछु !
              ...
              <div class=" labell">
               ...
               <div class="row">
                  <div class="col-md-12">
                   जन्मस्थान  :-
                  <input type="text" class="dashed-input-field" placeholder="   *" name="birth_place" required="required" value="{{$data->birth_place}}"></div>
                   <div class="col-md-12">
                  बाबुको नाम थर, वतन :-
                  ...
                  <input type="text" class="dashed-input-field" placeholder="   *" name="patipatni_name" required="required" value="{{$data->patipatni_name}}"></div>
                  <div class="col-md-12">
                  स्थायी ठेगाना  :-
                  <input type="text" class="dashed-input-field" placeholder="   *" name="per_add" required="required" value="{{$data->per_add}}"></div>
                  <div class="col-md-12">
                  सम्बन्धित व्यक्तिको नाम थर, वतन :-
                  <input type="text" class="dashed-input-field" placeholder="   *" name="person_name" required="required" value="{{$data->person_name}}"></div>
                  <div class="col-md-12">
                  जन्म मिति :-
                  <input type="text" class="dashed-input-field ndp-nepali-calendar" placeholder="   *" name="birth_date" id="birth_date" required="required" onfocus="showNdpCalendarBox('birth_date')" value="{{$data->birth_date}}"></div>
                  <div class="col-md-12">
                  जिल्ला प्रशासनबाट खटिएको नागरिकता टोलीमा नाम दर्ता  :-
                  <input type="text" class="dashed-input-field" placeholder="   *" name="toli_ko_name" required="required" value="{{$data->toli_ko_name}}"></div>
                  <div class="col-md-12">
...
<option value="निवेदक" {{ $data->nibedak_options == 'निवेदक' ? 'selected' : ''}}>निवेदक</option>
<option value="निबेदिका" {{ $data->nibedak_options == 'निबेदिका' ? 'selected' : ''}}>निबेदिका</option>
</select>
<input type="text" class="dashed-input-field" placeholder="   *" name="nibedan_name" required="required" value="{{$data->nibedan_name}}"> मेरो <input type="text" class="dashed-input-field" placeholder="   *" name="nibedan_relation" required="required" value="{{$data->nibedan_relation}}">नाता हुन् ! निजले हालसम्म कही  कतैबाट नेपाली नागरिकताको प्रमाण-पत्रलीएको छैन ! ब्येहोरा झुट्ठा ठहरेमा कानुन बमोजिम सहुँला बुझाउला भनि सनाखत र सहिछाप गर्नेको : </p>
              </div>
            </div>
            <div class="col-md-12">
             <div class="col-md-6">
              <p align="left">
                  नाम  :-
                  <input type="text" class="dashed-input-field" placeholder="   *" name="sanakhat_name" required="required" value="{{$data->sanakhat_name}}"><br>
                  ना.प्र नं. :-
                  <input type="text" class="dashed-input-field" placeholder="   *" name="sanakhat_relation" required="required" value="{{$data->sanakhat_relation}}"><br>
                  
                  सही छाप :-
                  <br>
                  मिति   :-
                  <input type="text" class="dashed-input-field ndp-nepali-calendar" name="sanakhat_date" placeholder="   *" required="required" id="sanakhat_date" onfocus="showNdpCalendarBox('sanakhat_date')" value="{{$data->sanakhat_date}}"></p></div>
