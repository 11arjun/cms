...
<link rel="stylesheet" href="{{ asset('admin/bower_components/bootstrap/dist/css/bootstrap.min.css') }}">
      ...
      <a class="btn btn-success"  href="CitizenshipCertificate/{{$data->id}}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
...
<page size="A4"  class="short">
   ...
   <div class="x_content">
      ...
      <div class="row">
         ...
         <div class="col-md-6">
            <p style="float: left;"><b>१ नं. प्रदेश, नेपाल</b></p>
...
<div class="col-md-12">
   <center>
      ...
      <!-- <a class="btn btn-success btn-fixed"  href="CitizenshipCertificate/{{$data->id}}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
        <a class="btn btn-success btn-fixed" id="print_certificate"><span class="glyphicon glyphicon-print"></span> प्रिन्ट गर्नुहोस </a> -->
      <a class="btn btn-success btn-fixed" href="{{url('CitizenshipCertificate/create')}}"><span class="glyphicon glyphicon-print"></span> नयाँ फर्म खोल्नुहोस</a>
   </div>
   </center>
</div>
<!-- jQuery -->
