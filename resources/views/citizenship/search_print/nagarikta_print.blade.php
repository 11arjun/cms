...
<link rel="stylesheet" href="{!! asset('admin/bower_components/bootstrap/dist/css/bootstrap.min.css') !!}">
  ...
  <a class="btn btn-success"  href="Nagarikta/{!!$data->id!!}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
          ...
          <div class="row top-part">
            ...
            <div class="row title-left">
              <div class="col-md-6">
                ...
                <p><b>{!!$data->ward_num!!}</b>&nbsp;वडा कार्यालय,{{$district[0]->district_name}}।
                </p>
              </div>
              <div class="col-md-6">
...
<div class="col-md-12">
   <center>
     <div class="hide-button">
      ...
      <!-- <a class="btn btn-success btn-fixed"  href="Nagarikta/{!!$data->id!!}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
          <a class="btn btn-success btn-fixed" id="print_certificate"><span class="glyphicon glyphicon-print"></span> प्रिन्ट गर्नुहोस </a> -->
      <a class="btn btn-success btn-fixed" href="{!!url('Nagarikta/create')!!}"><span class="glyphicon glyphicon-print"></span> नयाँ फर्म खोल्नुहोस</a>
    </div>
   </center>
</div>
<!-- jQuery -->
