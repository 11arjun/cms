  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('janmamitipramanit')}}" method="post">
          {{ csrf_field() }}
          ...
          <div class="x_content">
            @include('master.master_header_ne2')
              ...
              <div class="col-md-12">
                ...
                <p align="left"> निवेदक श्री <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="father_name"/> तथा श्रीमती  <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="mother_name"/>को निवेदन अनुसार उँहाहरुको
             <select name="children_gender">
              <option value="छोरा">छोरा</option>
              <option value="छोरी">छोरी</option>
            </select>

                   वडा नं. {{Helpers::convertNos(auth()->user()->isAdmin)}} स्थायी  ठेगाना  (साबिकको ठेगाना <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="sabik_address"/>) भएको
            <select name="children_title">
              ...
              <option value="श्रीमती">श्रीमती</option>
                  ...
                  को जन्म मिति  <input type="text" class="dashed-input-field ndp-nepali-calendar" placeholder="   *" required="required" id="birth_date" name="birth_date" onfocus="showNdpCalendarBox('birth_date')"> गते पेश गरेको कागजातका आधारमा <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="birth_place"/>स्थानमा भएको व्यहोरा प्रमाणित गरिन्छ |
