  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('natapramanit',[$data->id])}}" method="post">
          {{method_field('PATCH')}}
           {{ csrf_field() }}
          ...
          @include('master.master_header_ne2')
            ...
            <div class="col-md-12">
              ...
              <input type="text" class="dashed-input-field" placeholder="   *" name="person_name" id="person_name" required="required" value="{{$data->person_name}}" />
              ...
              <table class="table table-bordered" id="nata_sambandha_table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="relative_name[]" value="{{$d->relative_name}}"> </td>
                    <td><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="relation[]" value="{{$d->relation}}"> </td>
