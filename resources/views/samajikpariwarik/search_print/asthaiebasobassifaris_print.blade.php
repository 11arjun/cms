...
@foreach($data as $data)
    ...
    <a class="btn btn-success"  href="asthaiebasobasSifaris/{{$data->id}}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
      ...
      <div class="x_panel">
        <div class="x_content">
          ...
          <div class="col-md-12" style="margin-top: 40px;">
            ...
            <div class="col-md-8">
              ...
              <div class="row title-left">
                  <div class="col-md-12">
                     <h4 align="center">अस्थायी बसोबास सिफारिस</h4>
                  </div>
              </div>
            <div class="row title-left">
              <div class="col-md-6">
          ...
          <div class="col-md-12">
            ...
            <p align="left"><b>{{$data->person_title}} {{$data->person_name}}</b>
            <b> {{$local_state[0]->local_state_name}}</b> वडा नं.  <b> {{Helpers::convertNos(auth()->user()->isAdmin)}}</b> (साबिकको ठेगाना <b>{{$data->sabik_address}}"</b>) अन्तर्गत  तल उल्लेखित स्थानमा रहेको घरधनी <b>{{$data->houseowner_title}}
            {{$data->houseowner_name}}</b> को घरमा विगत मिति <b>{{$data->living_starting_date}}</b> देखि अस्थायी बसोबास गर्दै आउनु भएको व्यहोरा सिफारिस साथ अनुरोध गरिन्छ | </p>
             </div>
             <div class="col-md-12">
              <div class="col-md-12">

                <p><i>बसोबास गर्नेको ना.प्र.प.न.</i> <b>{{$data->citizenship_no}}</b> / जिल्ला <b>{{$data->district_name}}</b> / जारी  मिति <b>{{$data->citizenship_issued_date}}</b>  </p>
              </div>
...
<div class="col-md-12">
   <center>
    <div class="hide-button">
      ...
      <!-- <a class="btn btn-success btn-fixed"  href="asthaiebasobasSifaris/{{$data->id}}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
      <a class="btn btn-success btn-fixed" id="print_certificate"><span class="glyphicon glyphicon-print"></span> प्रिन्ट गर्नुहोस </a> -->
      <a class="btn btn-success btn-fixed" href="{{url('asthaiebasobasSifaris/create')}}"><span class="glyphicon glyphicon-print"></span> नयाँ फर्म खोल्नुहोस</a>
    </div>
   </center>
</div>
<!-- jQuery -->
