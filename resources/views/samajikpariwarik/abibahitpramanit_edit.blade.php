  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('abibahitpramanit',[$data->id])}}" method="post">
          {{method_field('PATCH')}}
          {{ csrf_field() }}
          ...
          <div class="x_content">
           ...
           <div class="col-md-12">
            <div class="col-md-6">
              <p align="left" ><b>चलानी नं.&nbsp;<input type="text" class="{{Helpers::convertNos(auth()->user()->isAdmin)}}dashed-input-field" placeholder="   *"  name="chalani_no" id="chalani_no" required="required" value="{{$data->chalani_no}}" /></b></p>
          ...
          <div class="col-md-12">
            ...
            <p align="left"><b>{{$local_state[0]->local_state_name}}</b> वडा नं.  <b>{{Helpers::convertNos(auth()->user()->isAdmin)}}</b>  (साबिकको ठेगाना
              <input type="text" name="sabik_address" class="dashed-input-field" required="required" placeholder=" *" value="{{$data->sabik_address}}"> ) निवासी श्री <input type="text" class=" dashed-input-field" placeholder=" *" required="required" name="father_name" value="
              {{$data->father_name}}" />तथा श्रीमती <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="mother_name" value="{{$data->mother_name}}" /> को
