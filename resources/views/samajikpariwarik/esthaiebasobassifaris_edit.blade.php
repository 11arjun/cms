  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('esthaiebasobasSifaris',[$data->id])}}" method="POST">
          {{method_field('PATCH')}}
          {{ csrf_field() }}
          ...
          <div class="col-md-12">
           ...
           <p>निवेदक
            ...
            <select name="houseowner_title">
              ...
              <b> {{$local_state[0]->local_state_name}} </b> वडा नं.  <b> {{Helpers::convertNos(auth()->user()->isAdmin)}} </b> (साबिकको ठेगाना <input type="text" class="dashed-input-field star" name="sabik_address" id="sabik_address" autocomplete="off" required="required" value="{{$data->sabik_address}}"> देखि स्थायी बसोबास गर्दै आउनु भएको व्यहोरा सिफारिस साथ अनुरोध गरिन्छ |  अन्तर्गत  तल उल्लेखित स्थानमा विगत मिति <input type="text" class="dashed-input-field ndp-nepali-calendar" placeholder="   *" name="living_starting_date" id="living_starting_date" required="required" onfocus="showNdpCalendarBox('living_starting_date')" value="{{$data->living_starting_date}}"></p>
<!--              </div>
             <div class="col-md-12">
              <div class="col-md-12"> -->
                <p><i>बसोबास गर्नेको ना.प्र.प.न. <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="citizenship_no" value="{{$data->citizenship_no}}">/ जिल्ला- <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="district_name" value="{{$data->district_name}}">/ जारी  मिति- <input type="text" class="dashed-input-field" placeholder="   *" required="required" id="citizenship_issued_date" name="citizenship_issued_date" value="{{$data->citizenship_issued_date}}"></i> </p>
             </div>
