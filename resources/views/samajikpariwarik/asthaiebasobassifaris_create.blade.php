  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('asthaiebasobasSifaris')}}" method="post">
          {{ csrf_field() }}
          ...
          <div class="x_content">
           ...
           <div class="col-md-12">
            ...
            <div class="col-md-6">
              <p align="right" class="star"><b>मिति :<input type="text" class="dashed-input-field ndp-nepali-calendar" placeholder="   *" name="issued_date" id="issued_date" required="required" onfocus="showNdpCalendarBox('issued_date')" autocomplete="off"></b></p>
            </div>
          </div>
          ...
          <div class="col-md-12">
            ...
            <p>
              ...
              <b> {{$local_state[0]->local_state_name}}</b> वडा नं.  <b> {{Helpers::convertNos(auth()->user()->isAdmin)}} </b> (साबिकको ठेगाना <input type="text" class="dashed-input-field star" name="sabik_address" id="sabik_address" autocomplete="off" required="required">) अन्तर्गत  तल उल्लेखित स्थानमा रहेको घरधनी
            ...
            <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="houseowner_name">
               को घरमा विगत मिति <input type="text" class="dashed-input-field ndp-nepali-calendar" placeholder="   *" name="living_starting_date" id="living_starting_date" required="required" onfocus="showNdpCalendarBox('living_starting_date')" autocomplete="off"> देखि अस्थायी बसोबास गर्दै आउनु भएको व्यहोरा सिफारिस साथ अनुरोध गरिन्छ | </p>
             </div>
             <div class="col-md-12">
              <div class="col-md-12">

                <p><i>बसोबास गर्नेको ना.प्र.प.न.</i> <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="citizenship_no">/ जिल्ला <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="district_name">/ जारी  मिति <input type="text" class="dashed-input-field ndp-nepali-calendar" placeholder="   *" required="required" id="citizenship_issued_date" name="citizenship_issued_date" onfocus="showNdpCalendarBox('citizenship_issued_date')">  </p>
              </div>
