...
@foreach($data as $data)
 ...
 <a class="btn btn-success"  href="MuchulkaController/{{$data->id}}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
...
</b> वडा नं. <b>{{$data->sabik_ward}}</b> हाल  <b>{{$data->local_states}}</b> वडा नं. <b>{{$data->wards}}</b> बस्ने <b> {{$data->landowner_name}}</b> को नाममा मालपोत कार्यालय {{$data->malpot_address}} मा दर्ता कायम रहेको साविक
 ...
 <div class="col-md-12">
   <center>
    <div class="hide-button">
      ...
      <!-- <a class="btn btn-success btn-fixed"  href="MuchulkaController/{{$data->id}}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
      <a class="btn btn-success btn-fixed" id="print_certificate"><span class="glyphicon glyphicon-print"></span> प्रिन्ट गर्नुहोस </a> -->
      <a class="btn btn-success btn-fixed" href="{{url('MuchulkaController/create')}}"><span class="glyphicon glyphicon-print"></span> नयाँ फर्म खोल्नुहोस</a>
    </div>
   </center>
</div>
<!-- jQuery -->
