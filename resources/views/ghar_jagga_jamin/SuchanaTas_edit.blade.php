...
@endpush
@section('content')
<div class="right_col nep" role="main" style="min-height: 1306px;">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_title">
          <h3 class="title-x"> सूचना टाँस </h3>
         
          <div class="clearfix"></div>
        </div>
<div class="x_content">
   
<form action="{{url('SuchanaTasController', [$data->id])}}" method="POST" >
           {{method_field('PATCH')}}
          {{ csrf_field() }}
  ...
  <div class="row title-left">
    <div class="col-md-12">
     <b> <p>श्री यो जो सँग सम्बन्धित छ।</p>
      <input type="hidden" name="karyalaya_name" value="श्री यो जो सँग सम्बन्धित छ">
      </b><p><b></b> 
...
</b> वडा नं. <b><input type="text" class="dashed-input-small-field" placeholder="   *" required="required" name="sabik_ward" value="{{$data->sabik_ward}}"></b> हाल  <b><input type="text" class="dashed-input-field" placeholder="   *" name="local_states" required="required" value="{{$data->local_states}}"></b> वडा नं. <b><input type="text" class="dashed-input-small-field" placeholder="   *" name="wards" value="{{$data->wards}}" required="required"></b> बस्ने <b> <input type="text" class="dashed-input-field" placeholder="   *" name="landowner_name" required="required" value="{{$data->landowner_name}}"></b> को नाममा मालपोत कार्यालय <input type="text" class="dashed-input-field" placeholder="   *" name="malpot_address" required="required" value="{{$data->malpot_address}}"> मा दर्ता कायम रहेको साविक 
...
</b> वडा नं. <b><input type="text" class="dashed-input-small-field" placeholder="   *" required="required" name="landsabik_ward" value="{{$data->landsabik_ward}}"></b> को कित्ता नं. <b><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="kitta_no" value="{{$data->kitta_no}}"> </b> क्षेत्रफल क्रमश  <b><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="area" value="{{$data->area}}"> </b> को जग्गामा साविक <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="appsabik_address" value="{{$data->appsabik_address}}"> <b><select name="appsabik_type">
...
</b> वडा नं. <b><input type="text" class="dashed-input-small-field" placeholder="   *" required="required" name="appsabik_ward" value="{{$data->appsabik_ward}}"></b> हाल  <b><input type="text" class="dashed-input-field" placeholder="   *" name="applocal_states" value="{{$data->applocal_states}}" required="required"></b> वडा नं. <b><input type="text" class="dashed-input-small-field" placeholder="   *" name="appward" value="{{$data->appward}}" required="required"></b> बस्ने <b><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="applicant_name" value="{{$data->applicant_name}}"> </b> ले आवासीय घर <b> <select name="home_type" onchange="myFunction()" id="mySelect">
<option value="बनाउन" {{ $data->home_type == 'बनाउन' ? 'selected' : ''}}>बनाउन</option>
<option value="नियमित गर्न" {{ $data->home_type == 'नियमित गर्न' ? 'selected' : ''}}>नियमित गर्न</option>
</select>
</b> नक्सा पास गरी पाऊँ भन्ने दरखास्त परेको हुनाले नगरपालिका ऐन अनुसार यो सूचना पठाउने काम भएको छ।सो नक्सा बमोजिमको घर  <b><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="home_type2" readonly="readonly" id="home_type2" value="{{$data->home_type2}}"> </b>  कहिँ कसैलार्इ पिरमर्का सन्धिसर्पन पर्ने भएमा यो सूचना पाएको वा घर दैलोमा टाँसेको मितिले १५ दिन भित्र यस वडा कार्यालयमा आफ्नो दावी खुलेको उजुरी दिनुहोला।सो १५ दिन भित्र उजुरी नपरेमा अर्जी पर्न र म्याद थमाइ पाऊँ भन्ने उजुरी समेत नलाग्ने तथा नियमानुसार नक्सा पास हुने व्यहोरा समेत सूचित गरिन्छ।
        </p>
...
<input type="text" name="user_id" value="{{auth()->user()->isAdmin}}" style="display: none;">
  ...
  <center><input type="submit" class="btn btn-success" name="save_suchanatas_data" value="रेकर्ड सेभ गरी प्रिन्टको लागि तयार गर्नुहोस"></center>
</div>
</form>
</div>
