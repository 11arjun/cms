...
<div class="x_content">
             ...
             <form action="{{url('ShrestaUparSifarisController', [$data->id])}}" method="POST" >
           {{method_field('PATCH')}}
          {{ csrf_field() }}
...
<div class="row title-left">
  <div class="col-md-12">
    <p align="left"><b>श्री <input type="text" class="dashed-lg-input" placeholder="   *" name="karyalaya_name" value="{{$data->karyalaya_name}}" required="required"></b>,</p>
...
<option value="महानगरपालिका" {{ $data->sabik_type == 'महानगरपालिका' ? 'selected' : ''}}> महानगरपालिका</option>
      ...
      वडा नं. <input type="text" class="dashed-input-small-field star" placeholder="   *" name="sabik_ward" id="sabik_ward" required="required" value="{{$data->sabik_ward}}">हाल <input type="text" class="dashed-input-field" placeholder="   *" name="local_state" id="local_state" value="{{$data->local_state}}" required="required"> वडा नं.  <b> <input type="text" class="dashed-input-small-field" placeholder="   *" name="ward" value="१" required="required" value="{{$data->ward}}"></b>
      बस्ने
      <b> <input type="text" class="dashed-input-field" placeholder="   *" name="owner_name" required="required" value="{{$data->owner_name}}"></b> को नाममा <input type="text" class="dashed-lg-input" placeholder="   *" name="of_name" required="required" value="{{$data->of_name}}"> <input type="text" class="dashed-input-field" placeholder="   *" name="of_address" required="required" value="{{$data->of_address}}">मा दर्ता कायम रहेको तपशिलमा उल्लेखित कित्ता जग्गाहरुको श्रेष्ता कार्यालय प्रयोजनको लागि आवश्यक परेको हुदा उक्त कित्ता जग्गाहरुको श्रेष्ता तयार गरी पठाईदिनु हुन सिफारिस साथ अनुरोध गरिन्छ । 
