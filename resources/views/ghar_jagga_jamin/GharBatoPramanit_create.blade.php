...
<div class="right_col" role="main">
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('gharbatopramanit')}}" method="post">
           {{ csrf_field() }}
 ...
 --}}
          ...
          <div class="col-md-12">
            ...
            <p align="left">श्री <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="office_chairman"/> </p>
              <p align="left">&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="office_name"/>।</p>
          ...
          <div class="col-md-12">
            ...
            <p align="left"><b> {{$local_state[0]->local_state_name}} </b> वडा नं.<b> {{Helpers::convertNos(auth()->user()->isAdmin)}} </b> (साबिकको ठेगाना <input type="text" name="sabik_address" class="dashed-input-field" required="required" placeholder=" *">) अन्तर्गत 
             ...
             <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="person_name"/> को नाममा त्यस कार्यलयमा श्रेस्ता दर्ता कायम रहेको जग्गाको घरबाटो तपसिलमा उल्लेखित विवरण अनुसार भएको व्यहोरा प्रमाणित गरिन्छ।</p>
          </div>
          <div class="col-md-12">
                ...
                <table class="table table-bordered" id="ghar_bato_bibaran_table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><input type="text" class="dashed-input-small-field" placeholder="   *" required="required" name="seat_no[]"> </td>
                      ...
                      <td><input type="text" class="dashed-input-small-field" placeholder="   *" required="required" name="ghar_abastha[]"> </td>
                      <td><input type="text" class="dashed-input-small-field" placeholder="   *" required="required" name="bato_type[]"> </td>
      ...
      <input type="text" name="nibedak_nid" class="form-control" required>
          ...
          <div class="col-md-12">
            ...
            <center><input  type="submit" class="btn btn-success" name="save_ghar_bato_pramanit_data" value="रेकर्ड सेभ गरी प्रिन्टको लागि तयार गर्नुहोस"></center>
          </div>
        </div>
      </div>
