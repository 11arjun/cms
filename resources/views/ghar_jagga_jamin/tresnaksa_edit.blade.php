...
<form action="{{url('tresnaksa', [$data->id])}}" method="POST" >
           {{method_field('PATCH')}}
          {{ csrf_field() }}
...
<option value="महानगरपालिका" {{ $data->sabik_type == 'महानगरपालिका' ? 'selected' : ''}}> महानगरपालिका</option>
      ...
      वडा नं. <input type="text" class="dashed-input-small-field star" placeholder="   *" name="sabik_ward" id="sabik_ward" required="required" value="{{$data->sabik_ward}}">) बस्ने 
      <input type="text" class="dashed-input-field star" placeholder="   *" name="nibedak" id="nibedak" required="required" value="{{$data->nibedak}}"> को नाममा दर्ता भएको <b> <input type="text" class="dashed-input-field" placeholder="   *" name="plot_local_state_name" id="plot_local_state_name" value="{{$data->plot_local_state_name}}" required="required"></b> वडा नं.  <b> <input type="text" class="dashed-input-small-field" placeholder="   *" name="plot_ward_no" value="{{$data->plot_ward_no}}" required="required"></b>
      (साविक<!--SABIK ADDRESS START -->

                  <input type="text" class="dashed-input-field star" placeholder="   *" name="plot_sabik_address" id="plot_sabik_address" required="required" value="{{$data->plot_sabik_address}}">
        
        <b><select name="plot_sabik_type">
<option value="गा.वि.स." {{ $data->plot_sabik_type == 'गा.वि.स.' ? 'selected' : ''}}>गा.वि.स.</option>
<option value="नगरपालिका" {{ $data->plot_sabik_type == 'नगरपालिका' ? 'selected' : ''}}>नगरपालिका</option>
<option value="उप महानगरपालिका" {{ $data->plot_sabik_type == 'उप महानगरपालिका' ? 'selected' : ''}}>उप महानगरपालिका</option>
<option value="महानगरपालिका" {{ $data->plot_sabik_type == 'महानगरपालिका' ? 'selected' : ''}}> महानगरपालिका</option>
</select>
</b>


        <!-- SABIK ADDRESS END -->
        वडा नं. <input type="text" class="dashed-input-small-field star" placeholder="   *" name="plot_sabik_ward" id="plot_sabik_ward" required="required" value="{{$data->plot_sabik_ward}}">) 


        कि. नं. <input type="text" class="dashed-input-field star" placeholder="   *" name="kitta_no" id="" required="required" value="{{$data->kitta_no}}"> क्षे. फ.<input type="text" class="dashed-input-field star" placeholder="   *" name="area_no" id="" required="required" value="{{$data->area_no}}">
        को  ट्रेस नक्सा 
        <b> <input type="text" class="dashed-input-field" placeholder="   *" name="request_for" required="required" value="{{$data->request_for}}"></b>
