...
<form action="{{url('SuchanaTasController')}}" method="post">
             {{ csrf_field() }}
...
</b> वडा नं. <b><input type="text" class="dashed-input-small-field" placeholder="   *" required="required" name="sabik_ward"></b> हाल  <b><input type="text" class="dashed-input-field" placeholder="   *" name="local_states" value="{{$local_state[0]->local_state_name}}" required="required"></b> वडा नं. <b><input type="text" class="dashed-input-small-field" placeholder="   *" name="wards" value="१" required="required"></b> बस्ने <b> <input type="text" class="dashed-input-field" placeholder="   *" name="landowner_name" required="required"></b> को नाममा मालपोत कार्यालय <input type="text" class="dashed-input-field" placeholder="   *" name="malpot_address" required="required" value="{{$district[0]->district_name}}"> मा दर्ता कायम रहेको साविक 
