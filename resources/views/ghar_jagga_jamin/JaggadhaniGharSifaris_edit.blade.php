...
<div class="right_col" role="main">
 ...
 <div class="x_content">
        ...
        <form action="{{url('jaggadhnigharsifaris',[$data->id])}}" method="post">
            {{method_field('PATCH')}}
          {{ csrf_field() }}
...
{{--                <p align="left"><b>पत्र संख्या&nbsp;<input type="text" class="dashed-input-field" placeholder="   *" name="patra_sankya" value="{{$data->patra_sankya}}" id="patra_sankya" required="required"/></b></p>
 ...
 --}}             </div>
          ...
          <div class="col-md-12">
            ...
            <p align="left"> उपरोक्त सम्बन्धमा मेरो/हाम्रो नाममा एकलौटी/संयुक्त दर्ता श्रेस्ता भएको वडा नं.<input type="text" class="dashed-input-field" placeholder="   *" required="required" name="ward_no" value="{{$data->ward_no}}"/>(साबिकको ठेगाना <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="sabik_address" value="{{$data->sabik_address}}"/>)कि.नं. <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="kitta_no" value="{{$data->kitta_no}}"/>को क्षे.फ. <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="area" value="{{$data->area}}"/> जग्गाको जग्गाधनी श्रेस्ता पुर्जामा जग्गा मात्र भएको तर फिल्डमा घर भएकोले जग्गाधनी श्रेस्ता पुर्जामा घर कायम गरी पाउ भनी घरजग्गाधनी  
        ...
        <input type="text" name="nibedak_nid" class="form-control" value="{{$data->nibedak_nid}}" required>
            ...
            <div class="col-md-12">
              ...
              <center><input  type="submit" class="btn btn-success" name="update_jagga_dhani_praman_purja_ghar_kayem_data" value="रेकर्ड सेभ गरी प्रिन्टको लागि तयार गर्नुहोस"></center>
            </div>
          </div>
        </div>
