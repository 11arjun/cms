...
<div class="x_content">
             ...
             <form action="{{url('SuchanaTasGuthiController', [$data->id])}}" method="POST" >
           {{method_field('PATCH')}}
          {{ csrf_field() }}
  ...
  <div class="row title-left">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <p> उपरोक्त सम्बन्धमा  <b> <input type="text" class="dashed-input-field" placeholder="   *" name="landowner_name" required="required" value="{{$data->landowner_name}}"></b> गुठीको नाममा मालपोत कार्यालय <input type="text" class="dashed-input-field" placeholder="   *" name="malpot_address" required="required" value="{{$data->malpot_address}}"> मा दर्ता कायम रहेको साविक 
