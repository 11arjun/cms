  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('gharbatopramanit',[$data->id])}}" method="post">
           {{method_field('PATCH')}}
          {{ csrf_field() }}
          <div class="x_content">
          ...
          <div class="col-md-12">
            ...
            <p align="left">श्री <input type="text" class="dashed-input-field" placeholder="   *" required="required" value="{{$data->office_chairman}}" name="office_chairman"/> </p>
              <p align="left"><input type="text" class="dashed-input-field" placeholder="   *" value="{{$data->office_name}}" required="required" name="office_name"/>।</p>
          ...
          <div class="col-md-12">
            ...
            <p align="left"><b> {{$local_state[0]->local_state_name}}</b> वडा नं.<b> {{Helpers::convertNos(auth()->user()->isAdmin)}}</b> (साबिकको ठेगाना <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="sabik_address" value="{{$data->sabik_address}}"/>) अन्तर्गत 
             ...
             <input type="text" class="dashed-input-field" placeholder="   *" required="required" value="{{$data->person_name}}" name="person_name"/> को नाममा त्यस कार्यलयमा श्रेस्ता दर्ता कायम रहेको जग्गाको घरबाटो तपसिलमा उल्लेखित विवरण अनुसार भएको व्यहोरा प्रमाणित गरिन्छ।</p>
          </div>
          <div class="col-md-12">

            <h4 align="center"><b>घर बाटो विवरण</b></h4>
            <div class="col-md-12">
              <div class="table-responsive">
                ...
                @foreach($detail as $d)
                      <tr>
                        ...
                        <td><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="bato_type[]" value="{{$d->bato_type}}"></td> 
                        <td><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="ghar_abastha[]" value="{{$d->ghar_abastha}}"></td> 

                        <td><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="remark[]" value="{{$d->remark}}"></td> 



                        <td><a href="" id="add_more_ghar_bato_bibaran" class="btn btn-success" ><span class="glyphicon glyphicon-plus"></span></a></td>
        ...
        <input type="text" name="nibedak_nid" class="form-control" value="{{$data->nibedak_nid}}" required>
          ...
          <div class="col-md-12">
            ...
            <center><input  type="submit" class="btn btn-success" name="update_ghar_bato_pramanit_data" value="रेकर्ड सेभ गरी प्रिन्टको लागि तयार गर्नुहोस">
            </center>
          </div>
        </div>
      </div>
