  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('gharpatalsifaris')}}" method="post">
           {{ csrf_field() }}
          ...
          <div class="col-md-12">
            ...
            <p align="left"> उपरोक्त सम्बन्धमा <b>{{$local_state[0]->local_state_name}}</b> वडा न. <b> {{Helpers::convertNos(auth()->user()->isAdmin)}}</b> स्थित 
              ...
              <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="person_name"/>को 
              नाममा रहेको कि.नं.<input type="text" class="dashed-input-field" placeholder="   *" required="required" name="kitta_no"/>क्षे.फ़.<input type="text" class="dashed-input-field" placeholder="   *" required="required" name="area"/>मा बनेको घर भत्किई पाताल भएको सोही अनुसारको सिफारिस गरी पाउँ भनी यस वडा कार्यालयमा पर्न आएको निवेदन सम्बन्धमा उल्लेखित कि.नं. मा बनेको घर पाताल भएको व्यहोराको सिफारिस गरिन्छ |
      ...
      <input type="text" name="nibedak_nid" class="form-control" required>
          ...
          <div class="col-md-12">
            ...
            <center><input  type="submit" class="btn btn-success" name="save_ghar_patal_sifaris_data" value="रेकर्ड सेभ गरी प्रिन्टको लागि तयार गर्नुहोस"></center>
          </div>
        </div>
      </div>
