...
<form action="{{url('kakshyathap')}}" method="post">
             {{ csrf_field() }}
...
<div class="row title-left">
  <div class="col-md-12">
    ...
    <p align="left">  <input type="text" class="dashed-input-field" placeholder="   *" name="officer_name" id="officer_name" required="required">|</p>
...
<div class="row">
  <div class="col-md-12 content-para">
    ...
    <p>उपरोक्त सम्बन्धमा<input type="text" class="dashed-input-field" placeholder="   *" name="related_name" required="required">   <select name="option">
...
</select> वडा नं.{{Helpers::convertNos(auth()->user()->isAdmin)}}  अन्तर्गत रहेको <input type="text" class="dashed-input-small-field" placeholder="   *" name="school_name" required="required">को कक्षा थापाको स्वीकृतको लागि
