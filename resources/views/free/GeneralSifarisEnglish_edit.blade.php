    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="col-md-12 title_header">
         <h1 class="name_header">
             {{$provience[0]->province_name_english}} </h1>
        ...
        @endif
         ...
         <form action="{{url('GeneralSifarisEnglish', [$data->id])}}" method="POST" >
           {{method_field('PATCH')}}
          {{ csrf_field() }}
          @include('master.master_header_english')
            ...
            <div class="row top-part">
              <div class="col-md-6">
                {{-- <p align="left"><b>Ref No. :<input class="dashed-input-field" name="ref_no" type="text" value="{{$data->ref_no}}"></b></p> --}}
              </div>
              <div class="col-md-6">
                <p align="right"><b>Date :<input id="issued_date" required="required" name="issued_date" class="dashed-input-field ndp-nepali-calendar" placeholder="   *" type="text" onfocus="showNdpCalendarBox('issued_date')" value="{{$data->issued_date}}"></b> </p>
              </div>
            </div>
           ...
           <div class="col-md-12">
            ...
            <p align="left"> <input type="text" class="dashed-input-field" placeholder="   *" name="office_name" id="office_name" required="required" value="{{$data->office_name}}">, </p>
                ...
                <p align="left"><input type="text" class="dashed-input-field" placeholder="  " name="office_add" value="{{$data->office_add}}">|</p>
            ...
            <div class="row top-part">
            <div class="col-md-12">
               <h3 align="center"><b>Subject: <input id="subject" required="required" name="subject" class="dashed-input-field" placeholder="   *" type="text" value="{{$data->subject}}"></b></h3>
...
<option value="Ward Chairperson" {{ $data->officer == 'Ward Chairperson' ? 'selected' : ''}}>Ward Chairperson</option>
<option value="Ward Secretary" {{ $data->officer == 'Ward Secretary' ? 'selected' : ''}}>Ward Secretary</option>
</select>
 </p>
            </div>
