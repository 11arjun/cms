  ...
  {{-- <header>
    ...
    <div class="row">
      ...
      <div class="col-md-2">
                 ...
                 <form action="{{url('GeneralSifaris')}}" method="post">
          	 {{ csrf_field() }}
              @include('master.master_header_ne2')

            <div class="row top-part">
              <div class="col-md-6">
               {{-- <p align="left"><b>पत्र संख्या :<input type="text" class="dashed-input-field" placeholder="   *" name="patra_sankhya" id="patra_sankya" value="२०७५/०७६" required="required"></b></p> --}}
          ...
          <div class="row title-left">
           <div class="col-md-12">
            ...
            <p align="left">श्री <input type="text" class="dashed-input-field" placeholder="   *" name="office_name" id="office_name" required="required">, </p>
                ...
                <p align="left"><input type="text" class="dashed-input-field" placeholder="  " name="office_address2">|</p>
        ...
        <div class="row">
          <div class="col-md-12">
            <p align="center" class="font-size-24">
              </p><h4 align="center"><b>विषय: <input id="subject" required="required" name="subject" class="dashed-input-field" placeholder="   *" type="text">।</b></h4>
