  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <form action="{{url('khulaipathayeko', [$data->id])}}" method="post">
          {{method_field('PATCH')}}
          {{ csrf_field() }}
          <div class="x_content">
            ...
            <div class="col-md-12">
              <div class="col-md-6">
               <p align="left"><b>पत्र संख्या&nbsp;<input type="text" class="dashed-input-field" placeholder="   *"  value="{{$data->patra_shankhya}}" name="patra_shankhya" id="patra_shankhya" required="required"/></b></p>
           ...
           <div class="col-md-12">
            ...
            <p align="left"><b>&nbsp;&nbsp;&nbsp;श्री <input type="text" class="dashed-input-field" placeholder="   *" name="officer_name"  value="{{$data->officer_name}}" id="officer_name" required="required"/></b>कार्यालय,</p>
          ...
          <div class="col-md-12">
            <p align="center" class="font-size-24">
              <h4 align="center"><b><u>विषय: खलाई पठाएको|</u></b> </h4>
            </p>
          </div>
          <div class="col-md-12">
