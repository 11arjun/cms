...
<div class="x_content">
   @include('master.master_header_ne2')
      <form action="{{url('kothakhalisifaris',[$data->id])}}" method="post">
        {{method_field('PATCH')}}
             {{ csrf_field() }}
	...
	<div class="row title-left">
		<div class="col-md-12">
			<p>श्री <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="letter_subject" value="{{$data->letter_subject}}"></p>
...
<!-- END -->
	...
	<div class="col-md-12">
		...
		<center><input type="submit" class="btn btn-success" name="save_kothakhali_data" value="रेकर्ड सेभ गरी प्रिन्टको लागि तयार गर्नुहोस"></center>
	</div>
