...
<div class="x_content">
   @include('master.master_header_ne2')
      <form action="{{url('UdyogDartaSifaris')}}" method="post">
             {{ csrf_field() }}
	...
	<div class="row title-left">
		<div class="col-md-12">
			<p>श्री <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="office_chairman" value="घरेलु तथा साना उद्योग कार्यालय"></p>
	...
	<div class="row">
		<div class="col-md-12 content-para">
			...
			<p align="justify">
				...
				उपरोक्त सम्बन्धमा तहाँ कार्यालयको मिति <input type="text" class="dashed-input-field ndp-nepali-calendar" placeholder="   *" required="required" name="prapta_patra_miti" id="prapta_patra_miti" onfocus="showNdpCalendarBox('prapta_patra_miti')"> च.नं. <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="prapta_patra_no" id="prapta_patra_no"> 
				को प्राप्त पत्र अनुसार सम्बन्धित स्थानमा गई गाउँ सर्जमिन बुझी मुचुल्का यसै पत्र साथ राखी पठाएको र निज निवेदक <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="sanchalak_name" id="sanchalak_name">को नाममा दर्ता रहेको साविक <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="sabik_address" id="sabik_address"> हाल <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="current_address" id="current_address"> को जग्गा विवरण <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="jagga_bibaran" id="jagga_bibaran">को जग्गामा <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="bebasaye_objective" id="bebasaye_objective"> उदेश्यको  श्री <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="bebasaye_name" id="bebasaye_name"> संचालनका लागि दर्ता हुने फर्मले चौतर्फी सधियार र छरछिमेकका  साथसाथै सार्बजनिक महत्वको स्थान लगायत कुनै कुराहरुलाई असर नगर्ने भएको हुँदा निवेदकको फर्म नियम अनुसार दर्ता गरी दिनुहुन किटानी सिफारिस गरिएको व्यहोरा अनुरोध छ।
