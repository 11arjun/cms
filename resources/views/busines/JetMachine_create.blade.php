...
<div class="x_content">
   @include('master.master_header_ne2')
      <form action="{{url('jetmachine')}}" method="post">
             {{ csrf_field() }}
	...
	<div class="row title-left">
		<div class="col-md-12">
			<p><input type="text" class="dashed-input-field" placeholder="   *" required="required" name="letter_subject" value="ascascasc"></p>
			<p> <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="karyalaya_name" value="asvcjakbs">।</p>
    </div>
	</div>
	...
	<div class="row">
      ...
      <p>
        जेट मेशिन उपलब्ध गराउन पर्ने स्थान : <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="address" value="">
      </p>
      <p>
        बाटोको नाम : <input type="text" class="dashed-input-field" placeholder="    *" required="required" name="road_name" value="">
      </p>
		</div>
		<div class="col-md-12">
