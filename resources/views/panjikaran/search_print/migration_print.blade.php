...
@foreach($data as $data)
   ...
   <a class="btn btn-success"  href="migration/{!!$data->id!!}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
              ...
              <header>
                 <div class="col-md-12" style="margin-top: 40px;">
                  ...
                  <b>स्थानीय पञ्जीकाधिकारीको कार्यालय </b><br>
                          ...
                          वडा नं.<b>
                          {{Helpers::convertNos(auth()->user()->isAdmin)}} ,</b>@endif
                    ...
                    <header>
                       ...
                       <p align="center">Schedule-12 <br>(Related with Rule 7)<br>
                        ...
                        <b>Office of Local Registrar</b><br>
                         ...
                         @endif <b> {{$local_state[0]->local_state_name_english}} </b>
...
{!!$data->house_owner_name_eng!!} a resident of Ward No.<b>{{auth()->user()->isAdmin}} </b> {{$local_state[0]->local_state_name_english}} </b><br>
...
<div class="col-md-12">
   <center>
    <div class="hide-button">
      ...
      <!-- <a class="btn btn-success btn-fixed"  href="migration/{!!$data->id!!}/edit"><span class="glyphicon glyphicon-edit"></span>रेकर्ड सच्याउनुहोस </a>
      <a class="btn btn-success btn-fixed" id="print_certificate"><span class="glyphicon glyphicon-print"></span> प्रिन्ट गर्नुहोस </a> -->
      <a class="btn btn-success btn-fixed" href="{!!url('migration/create')!!}"><span class="glyphicon glyphicon-print"></span> नयाँ फर्म खोल्नुहोस</a>
    </div>
   </center>
</div>
@endforeach
