...
<form action="{{url('FarakFarakNameTharPramanit')}}" method="post">
          	 {{ csrf_field() }}
...
<option value="श्रीमती">श्रीमती</option>
      ...
      <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="person_name"> को नाम थर  
      <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="actual_document"> 
      को आधारमा <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="valid_dob"> भएको र निजको  नाम थर <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="mistake_document"> मा <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="mistake_dob">हुन गएकोले  सो फरक हुन गएको नाम थर  भएको व्यक्ति एकै भएको प्रमाणित गरी पाऊँ भनी यस कार्यालयमा पेश हुन आएको निवेदन तथा सर्जमिनका आधारमा निजले पेश गरेको व्यहोरा मनासिब भएकोले  सो  नाम थर  भएको व्यक्ति फरक फरक नभई एकै भएको सिफारिस गरिन्छ।</p>
    </div>
  </div>
