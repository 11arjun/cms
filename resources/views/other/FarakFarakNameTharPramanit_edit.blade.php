...
<div class="x_content">
   @include('master.master_header_ne2')
    ...
    <form action="{{url('FarakFarakNameTharPramanit', [$data->id])}}" method="POST" >
           {{method_field('PATCH')}}
          {{ csrf_field() }}
...
<div class="row">
  <div class="col-md-12">
    <p align="center" class="font-size-24">
      ...
      <input type="hidden" name="letter_subject" value="फरक फरक नाम थर प्रमाणित">
    <p></p>
  </div>
</div>
  ...
  <div class="col-md-12">
    ...
    <p align="left"> उपरोक्त विषयमा <b><input type="text" class="dashed-input-field" placeholder="   *" name="local_state" value="{{$data->local_state}}" required="required"></b> वडा नं. <b><input type="text" class="dashed-input-small-field" placeholder="   *" name="ward" value="{{$data->ward}}" required="required"></b> (साविक 
      ...
      <!--SABIK ADDRESS START -->
              ...
              <input type="text" class="dashed-input-field star" placeholder="   *" name="sabik_address" id="sabik_address" required="required"  value="{{$data->sabik_ward}}">
...
</b>, वडा नं. <input type="text" class="dashed-input-small-field star" placeholder="   *" name="sabik_ward" id="sabik_ward" required="required" value="{{$data->sabik_ward}}">) निवासी <b><select name="person_title">
...
<option value="श्रीमती" {{ $data->person_title == 'श्रीमती' ? 'selected' : ''}}>श्रीमती</option>
      ...
      <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="person_name" value="{{$data->person_name}}"> को नाम थर  
      <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="actual_document" value="{{$data->actual_document}}"> 
      को आधारमा <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="valid_dob" value="{{$data->valid_dob}}"> भएको र निजको  नाम थर <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="mistake_document" value="{{$data->mistake_document}}"> मा <input type="text" class="dashed-input-field" placeholder="   *" required="required" name="mistake_dob" value="{{$data->mistake_dob}}">हुन गएकोले  सो फरक हुन गएको नाम थर  भएको व्यक्ति एकै भएको प्रमाणित गरी पाऊँ भनी यस कार्यालयमा पेश हुन आएको निवेदन तथा सर्जमिनका आधारमा निजले पेश गरेको व्यहोरा मनासिब भएकोले  सो  नाम थर  भएको व्यक्ति फरक फरक नभई एकै भएको सिफारिस गरिन्छ।</p>
    </div>
  </div>
